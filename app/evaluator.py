...
- Kế hoạch TOOLS yêu cầu search_products nhưng bot không gọi search_products
- Kế hoạch TOOLS yêu cầu get_media nhưng bot không gọi get_media (chỉ mô tả ảnh bằng text)
- Kế hoạch TOOLS yêu cầu get_product_detail nhưng bot không gọi tool đó
...
Tiêu chí PASS:
- Tools đã gọi khớp với TOOLS trong kế hoạch (hoặc hợp lý hơn)
